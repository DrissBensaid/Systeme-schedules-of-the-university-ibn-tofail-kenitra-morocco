...
@section('content')
    ...
    <div class="container w-100 d-flex justify-content-center align-items-center "
        ...
        <form class="p-2 d-flex flex-column justify-content-around align-items-center rounded" 
         ...
         action="{{route('admin.cours.store')}}" method="POST">
            @csrf
                ...
                <div class="mb-3 w-100 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <select name="jour"
                          style="border:solid 0.3px #3e4ea7; 
                                  ...
                                  border-radius:1px;"
                          class="form-control">
                      <option value="" disabled selected>SELECTER VOTRE JOUR</option>
                ...
                <div class="mb-3 w-100 d-flex flex-column justify-content-center align-items-center">
                  ...
                  <div class="mb-3 w-100 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <select 
                            ...
                            name="salle"
                            id="salle">
                            <option value="" disabled selected>SELECTER VOTRE SALLE</option>
                            <option value="pavion1" >pavion 1 </option>
