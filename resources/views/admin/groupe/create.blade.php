...
@section('content')
    ...
    style="max-height:86vh; overflow:auto; padding-top:130px; padding-bottom:20px;">
        ...
        <form class="p-2 d-flex flex-column justify-content-around align-items-center rounded" 
         ...
         action="{{route('admin.groupe.store')}}" method="POST">
            @csrf
        ...
        <script>
                    ...
                    //             success:function(data) {
                    //                 $(`#module${i}`).empty();
                    //                 $(`#module${i}`).append('<option value="" disabled selected>SELECTER VOTRE MODULE</option>');
                    //                 $.each(data, function(key, value) {
                    //                     $(`#module${i}`).append('<option value="' + key + '">' + value + '</option>');
                    //                 });
                    //             },
                    //             error:function(data) {
                    //                 alert('Error adding user.');
