...
@section('content')
    <div class="container w-100 d-flex flex-column justify-content-center align-items-center bg-light">
        ...
        <form class="p-2 d-flex flex-column justify-content-around align-items-center rounded" 
         ...
         action="/admin/filiere/{{$filiere['id']}}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3 w-100 d-flex flex-column justify-content-center align-items-center">
              ...
              style="color:#3e4ea7; font-weight: bold; width:80%;">FILIERE FR :</label>
              <input type="text" 
                     ...
                     id="$filiere->id" 
                     name="filiereFr" 
                     value="{{$filiere['filiereFr']}}"
                     placeholder="DONNER VOTRE FILIERE ...">
            </div>
            <div class="mb-3 w-100 d-flex flex-column justify-content-center align-items-center">
                <label for="prenom" class=""
                style="color:#3e4ea7; font-weight: bold; width:80%;">FILIERE AR :</label>
                <input type="text" 
                       style="border:solid 0.3px #3e4ea7; 
                              min-height:35px;
                              width:80%;
