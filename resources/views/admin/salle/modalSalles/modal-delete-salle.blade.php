<!-- Modal delete user-->
<div class="modal fade" id="deleteSalleModal" tabindex="-1"  aria-hidden="true">
    <div class="modal-dialog" >
      <div class="modal-content rounded-0" style="background-color:rgba(40, 57, 101, 0.774);">
        <div class="modal-header border-0">
          <h5 style="color:#fd5234;" class="modal-title w-100 text-center" id="muModalLabel">SUPPRIMER_SALLE</h5>
        ...
        <div class="modal-body">
            ...
            <div style="color:gold">
              ...
              es-tu sûr tu veux supprimer cette salle
            </div>
            <form id="deleteSalleForm" method="POST">
                @csrf
                @method('DELETE')
