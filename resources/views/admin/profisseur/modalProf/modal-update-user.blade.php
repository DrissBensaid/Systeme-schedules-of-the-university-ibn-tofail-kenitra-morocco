<!-- Modal update user-->
<div class="modal fade" id="updatenew" tabindex="-1"  aria-hidden="true">
    <div class="modal-dialog" >
      <div class="modal-content rounded-0" style="background-color:rgba(40, 57, 101, 0.774);">
        <div class="modal-header w-100 border-0">
          <h5 style="color:#fd5234;" class="modal-title w-100 text-center" id="muModalLabel">EDIT_PROFISSUER</h5>
        ...
        <div class="modal-body">
            ...
            <form id="updateForm">
                ...
                <div class="mb-3">
                  <label for="nom" style="color:#fd5234;">NOM :</label>
                  <input type="text" 
                ...
                <div class="modal-footer border-0 w-100 justify-content-around">
                  ...
                  <button type="submit" style="background-color:#fd5234; min-width:46%;"  class="btn text-light rounded-0">UPDATE</button> 
              </div>
